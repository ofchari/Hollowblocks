...
class _AgencyScreenState extends State<AgencyScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final url = '$apiUrl/Agency'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("Agency", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
