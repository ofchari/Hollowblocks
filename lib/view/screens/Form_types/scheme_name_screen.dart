...
class SchemeNameScreen extends StatefulWidget {
  ...
  @override
  State<SchemeNameScreen> createState() => _SchemeNameScreenState();
}

class _SchemeNameScreenState extends State<SchemeNameScreen> {
  late double height;
  late double width;
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final data = {
      'doctype': 'Scheme',
      'scheme': schemaController.text,
    };

    final url = '$apiUrl/Scheme'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("Scheme", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
