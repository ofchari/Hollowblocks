...
class _DistrictScreenState extends State<DistrictScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final url = '$apiUrl/District'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("District", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
