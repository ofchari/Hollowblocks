...
class _WorkGroupScreenState extends State<WorkGroupScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final data = {
      'doctype': 'Work Group',
      'work_group': workGroupController.text,
    };

    final url = '$apiUrl/Work Group'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("WorkGroup", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
