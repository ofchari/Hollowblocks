...
class _StatusScreenState extends State<StatusScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final data = {
      'doctype': 'Construction Status',
      'construction_status': statusController.text,
    };

    final url = '$apiUrl/Construction Status'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("Construction Status", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
