...
class _WorkTypeScreenState extends State<WorkTypeScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final url = '$apiUrl/Work Type'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("WorkType", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
