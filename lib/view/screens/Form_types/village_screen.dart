...
class _VillageScreenState extends State<VillageScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final url = '$apiUrl/Village'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("Village", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
