...
class _LevelScreenState extends State<LevelScreen> {
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    final url = '$apiUrl/Level'; // Replace with your actual API URL
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.snackbar("Level", " Document Posted Successfully",colorText: Colors.white,backgroundColor: Colors.green,snackPosition: SnackPosition.BOTTOM);
