...
// Modify your _calculateTotal method
  ...
  Future<void> postSingleMaterial(
    ...
    print('Sending Received request for material: ${material['material_name']}');
    ...
    if (response.statusCode == 200) {
      // Store successful Received data locally
  ...
  Future<void> MobileDocument(BuildContext context) async {
    ...
    try {
      ...
      Get.snackbar(
        "Success",
        "All Material Received Posted Successfully",
        colorText: Colors.white,
      ...
      final ReceivedList = selectedMaterials.map((material) {
      ...
      Get.off(
        ...
        arguments: {'Received': ReceivedList},
      );
    } catch (e) {
  ...
  void initState() {
    ...
    print("Project work  in Received: ${widget.work}"); // Debugging
    _initializeData();
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.to(() => CreateParty(sourceScreen: 'ReceivedScreen'));
                },
                child: Align(
